...
public class ControllerLocatario {
	...
	@GetMapping("/empresarial/locatario/opcoes")
	...
	public String LocatarioCadastro(Model model, @Valid LocatarioDto locatarioDto, BindingResult result) {
		if(result.hasErrors()) {
			model.addAttribute("mensagemErro", "Não foi possível realizar o cadastro do locatório");
			return "locatario/CadastroLocatario";
		}
		...
		try {
			...
			model.addAttribute("mensagemSucesso", "O locatório foi cadastrado com sucesso");
		}
	...
	public String LocatarioRemover(@RequestParam("cpf") String cpf, Model model) {
		try {
			...
			model.addAttribute("mensagemSucesso", "O locatório foi removido com sucesso");
		}
		catch(Exception e){
	...
	public String editarLocatario(Model model, @Valid @ModelAttribute LocatarioDto locatarioDto, BindingResult result) {
		...
		try {
			...
			model.addAttribute("mensagemSucesso", "Locatario atualizado com sucesso!");
		}catch(Exception e) {
			model.addAttribute("mensagemErro", e.getMessage());
		}
