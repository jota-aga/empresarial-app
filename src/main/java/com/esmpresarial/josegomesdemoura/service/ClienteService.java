...
public class ClienteService {
	...
	public void addCliente(Cliente cliente) throws CpfJaExisteException, CpfIncorretoException {
	...
	public void removerCliente(String cpf) throws ClienteNaoEncotradoException {
		Optional<Cliente> cliente = repo.findByCpf(cpf);
		if(cliente.isEmpty()) {
			throw new ClienteNaoEncotradoException();
		}
